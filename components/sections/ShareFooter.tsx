    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className={`mt-12 text-sm ${themeStyles.textMuted}`}>
          © 2025 Year in Review. Built by <a href="https://qed42.com" className="underline hover:text-blue-500">QED42</a>.
        </div>
      </div>
    </motion.footer>
  );
